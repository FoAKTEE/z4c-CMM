...
#   *_X5e-2 : X = 0.05 pair — absorption measurement (real constraint content)
...
run flat  z4c/cpbc=1 z4c/ccm=false problem/amp=0.0 z4c/ccm_amp=0.0 \
    time/tlim=10.0 mesh/nx1=64 mesh/nx2=64 mesh/nx3=64 \
    meshblock/nx1=32 meshblock/nx2=32 meshblock/nx3=32
run somm  z4c/cpbc=0 z4c/ccm=false
run cpbc  z4c/cpbc=1 z4c/ccm=false
run cpbc2 z4c/cpbc=1 z4c/ccm=false \
    mesh/nx1=248 mesh/nx2=248 mesh/nx3=248 \
    meshblock/nx1=124 meshblock/nx2=124 meshblock/nx3=124
run ccmcp z4c/cpbc=1 z4c/ccm=true z4c/ccm_mode=3
run somm_X5e-2 z4c/cpbc=0 z4c/ccm=false problem/amp=0.05 z4c/ccm_amp=0.05
run cpbc_X5e-2 z4c/cpbc=1 z4c/ccm=false problem/amp=0.05 z4c/ccm_amp=0.05
